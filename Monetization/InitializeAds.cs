...
public class InitializeAds : MonoBehaviour
{
    ...
    void Awake()
    {
        banner = FindObjectOfType<BannerAds>();
        ...
        rewarded.LoadRewardedAd(RewardedAds.RewardAdType.Cracker);
        rewarded.LoadRewardedAd(RewardedAds.RewardAdType.Resurrection);
    }
}
